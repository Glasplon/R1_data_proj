...
vannstand = [94, 43, 26, 61, 113, 138, 111, 59, 35, 64, 117, 146]  # Definerer funksjonen h
def h(t, A, phi, d): 
    return A*sin(0.524*t + phi) + d  # Bestemmer konstantene
[A, phi, d] = curve_fit(h, tid, vannstand)[0]
print("A =", round(A, 2))
print("phi =", round(phi, 2))
print("d =", round(d, 2))  # Plotter dataene sammen med grafen til h
